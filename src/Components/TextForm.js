    ...
    <div >
      <div className="mb-3 my-3"  >
        ...
        <textarea
          ...
          rows="10"
        ></textarea>
        <button className="btn btn-primary my-3" style={myStyle}  onClick={upperCase}>
          Convert to UPPERCASE
        </button>
        <button className="btn btn-primary my-3 mx-3" style={myStyle} onClick={lowerCase}>
          Convert to lowercase
        </button>
        <button className="btn btn-primary my-3 mx-3" style={myStyle} onClick={toggleStyle}>
          {theme}
        </button>
      </div>
    </div>
